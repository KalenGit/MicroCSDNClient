...
import com.haward.weblog.adapter.RecyclerViewAdapter;
...
public class myblogFragment extends Fragment {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            blogList = (ArrayList<BlogInfo>)msg.obj;
            adapter = new RecyclerViewAdapter(blogList,getActivity());
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_myblog,null);
        //LinearLayoutManager layoutManager=new LinearLayoutManager(getActivity());
        ...
        new Thread() {
            ...
            public void run() {
                super.run();
                blogList = httpUtil.getMyBlogs(getActivity());
